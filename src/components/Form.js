...
const InputFieldStyle = "form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none";

const AddButton = "w-1/2 font-man bg-blue-500 outline-none my-2 hover:bg-blue-700 text-white font-light py-2 px-4 rounded";

const RemoveButton = "w-1/2 font-man bg-red-500 outline-none m-2 hover:bg-red-700 text-white font-light py-2 px-4 rounded";

const Form = ({
                  resumeDetails, setResumeDetails, addCompontents, removeComponents, removeTags, setPicture, picture,
              }) => {
    return (<div className="w-full h-full flex items-start justify-center overflow-auto scrollbar-hide">
        <div className="w-5/6 h-full font-man">
                ...
                <div className="w-36 h-36 flex justify-center items-center rounded-full bg-slate-200 relative">
                    ...
                    <input
                        ...
                        onChange={(e) => {
                            ...
                            setResumeDetails({
                                ...resumeDetails, image_link: URL.createObjectURL(e.target.files[0]),
                            });
                        }}
                    />
                </div>
            ...
            <div className="my-3">
                ...
                <div className="flex">
                    ...
                    <button
                        onClick={() => {
                            ...
                            if (skill.length > 0) {
                                setResumeDetails({
                                    ...resumeDetails, skills: [...resumeDetails.skills, {skill_name: skill}],
                                });
                ...
                <div className="w-100 h-auto my-3 flex flex-row flex-wrap">
                    {resumeDetails.skills.map((skill, key) => (<div
                        key={key}
            ...
            <div className="my-3 flex flex-col">
                ...
                {resumeDetails.experiences.length > 0 && resumeDetails.experiences.map((component) => (
                ...
                <div className="flex">
                    {resumeDetails.experiences.length <= 2 ? (<button
                        onClick={() => {
                    ...
                    {resumeDetails.experiences.length >= 1 ? (<button
                        onClick={() => {
            ...
            <div className="my-3 flex flex-col">
                ...
                {resumeDetails.education.length > 0 && resumeDetails.education.map((component) => (
                    <div key={component.id}>
                        <Educations
                            index={component.id}
                            resumeDetails={resumeDetails}
                ...
                <div className="flex">
                    {resumeDetails.education.length <= 2 ? (<button
                        onClick={() => {
                    ...
                    {resumeDetails.education.length >= 1 ? (<button
                        onClick={() => {
            ...
            <div className="my-3 flex flex-col">
                ...
                {resumeDetails.projects.length > 0 && resumeDetails.projects.map((component) => (
                    <div key={component.id}>
                        <Projects
                            index={component.id}
                            resumeDetails={resumeDetails}
                ...
                <div className="flex">
                    {resumeDetails.projects.length <= 2 ? (<button
                        onClick={() => {
                    ...
                    {resumeDetails.projects.length >= 1 ? (<button
                        onClick={() => {
            ...
            <div className="my-3 flex flex-col">
                ...
                {resumeDetails.achievements.length > 0 && resumeDetails.achievements.map((component) => (
                    <div key={component.id}>
                        <Achievements
                            index={component.id}
                            resumeDetails={resumeDetails}
                ...
                <div className="flex">
                    {resumeDetails.achievements.length <= 2 ? (<button
                        onClick={() => {
                    ...
                    {resumeDetails.achievements.length >= 1 ? (<button
                        onClick={() => {
            ...
            <div className="my-3">
                    ...
                    <button
                        onClick={() => {
                            ...
                            if (interest.length > 0) {
                                setResumeDetails({
                                    ...resumeDetails,
                                    interests: [...resumeDetails.interests, {interest_name: interest}],
                                });
                ...
                <div className="w-100 h-auto my-3 flex flex-row flex-wrap">
                    {resumeDetails.interests.length > 0 && resumeDetails.interests.map((interest, key) => (<div
                        key={key}
                        className="flex justify-center items-center bg-slate-200 m-1 rounded-sm"
                    >
            ...
            <div className="my-3">
                    ...
                    <button
                        onClick={() => {
                            ...
                            if (language.length > 0) {
                                setResumeDetails({
                                    ...resumeDetails,
                                    languages_known: [...resumeDetails.languages, {lang_name: language},],
                                });
                ...
                <div className="w-100 h-auto my-3 flex flex-row flex-wrap">
                    {resumeDetails.languages.length > 0 && resumeDetails.languages.map((language, key) => (<div
                        key={key}
                        className="flex justify-center items-center bg-slate-200 m-1 rounded-sm"
                    >
