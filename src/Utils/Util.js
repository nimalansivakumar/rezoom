...
const Utils = {
  ...
  // },
  initializeUpdateComponent: () => {
    [
      ...document.getElementById("resume-form").querySelectorAll("input"),
    ].forEach((element) => {
    ...
    [
      ...document.getElementById("resume-form").querySelectorAll("#experiences-input input"),
    ].forEach((element) => {
      element.addEventListener("focus", (event) => {
        console.log(event.target.id);
      });
